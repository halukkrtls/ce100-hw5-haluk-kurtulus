...
namespace ce100_hw5_algo_test_cs
{
    ...
    public class UnitTest1
    {
        ...
        [TestMethod]
        public void BELLMAN_FORD_test1()
        {
            int V = 5;
            int E = 8;
            ...
            string result = "(Vertex --> Distance from Source)	(0 --> 0)	(1 --> -1)	(2 --> 2)	(3 --> -2)	(4 --> 1)";

            Assert.AreEqual(Graph3.BellmanFord(graph, 0), result);
        }

        [TestMethod]
        public void BELLMAN_FORD_test2()
        {
            int V = 5;
            int E = 8;
        ...
        [TestMethod]
        public void BELLMAN_FORD_test3()
        {
            int V = 5;
            int E = 8;
        ...
        [TestMethod]
        public void FORD_FULKERSON_test1()
        {
            int[,] graph = new int[,] {
            { 0, 16, 13, 4, 0, 0 },
            { 0, 0, 61, 12, 0, 0 },
        ...
        [TestMethod]
        public void FORD_FULKERSON_test2()
        {
            int[,] graph = new int[,] {
            { 0, 16, 13, 0, 5, 0 },
            { 0, 7, 10, 12, 0, 0 },
        ...
        [TestMethod]
        public void FORD_FULKERSON_test3()
        {
            int[,] graph = new int[,] {
            { 0, 16, 13, 6, 0, 0 },
            { 0, 4, 10, 12, 0, 0 },
